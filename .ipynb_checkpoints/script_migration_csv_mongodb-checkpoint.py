...
from parser_liste_env import parser_liste_env
from cleaning_df import (analyse_df, clean_columns_name, clean_columns_content,
    convert_type_date, convert_type_float, convert_type_integer)
from connexion_mongodb import connect_mongodb, disconnect_mongodb
...
def read_and_check_csv(path_csv:str):
    ...
    if not os.path.exists(path_csv):
        raise FileNotFoundError(f"Le fichier au chemin {path} est introuvable.") 
